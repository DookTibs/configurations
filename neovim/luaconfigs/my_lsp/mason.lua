...
if (java_lsp_needed ~= "" or python_lsp_needed ~= "") then
	...
	-- usually gi, but gi is a useful Vim map! imPPPPPlementation maybe as mnemonic?
	vim.api.nvim_set_keymap("n", "gp", "<cmd>lua vim.lsp.buf.implementation()<CR>", opts)
	-- vim.api.nvim_set_keymap("n", "K", "<cmd>lua vim.lsp.buf.hover()<CR>", opts)
	vim.api.nvim_set_keymap("n", "<C-s>", "<cmd>lua vim.lsp.buf.signature_help()<CR>", opts)
	-- I set these in main as ]d / [d
	...
	-- shows things like JavaDoc, python Docstrings, etc. does replace standard
	-- Vim K/keyword/keywordprg style behavior but that's ok.
